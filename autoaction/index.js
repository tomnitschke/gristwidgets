...
ready(function(){
  ...
  grist.ready({
    ...
    columns: [
      ...
      { name: ISONESHOT_COL_NAME, type: "bool", title: "One-shot?", description: "If this is True, actions will be executed just once per record (until the page gets reloaded). The default is True." },
    ],
  });
